...
SECRET_KEY = "django-insecure-p1^9cb9c=44^(u08h5)w$rxp-$0s^pv0kf_uc^+95zkj^n476h"
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "pong_project/templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
STATICFILES_DIRS = [BASE_DIR / "pong_project/static"]
