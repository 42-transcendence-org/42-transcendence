...
class TournamentData(BaseModel):
    ...
    player1: str = Field(..., nullable=False, max_length=50)
    player2: str = Field(..., nullable=False, max_length=50)
    player3: str = Field(..., nullable=False, max_length=50)
    player4: str = Field(..., nullable=False, max_length=50)
    game1_winner: str = Field(..., nullable=False, max_length=50)
    game1_loser: str = Field(..., nullable=False, max_length=50)
    game1_player1_score: int = Field(..., nullable=False)
    game1_player2_score: int = Field(..., nullable=False)
    game2_winner: str = Field(..., nullable=False, max_length=50)
    game2_loser: str = Field(..., nullable=False, max_length=50)
    game2_player1_score: int = Field(..., nullable=False)
    game2_player2_score: int = Field(..., nullable=False)
    game3_winner: str = Field(..., nullable=False, max_length=50)
    game3_loser: str = Field(..., nullable=False, max_length=50)
