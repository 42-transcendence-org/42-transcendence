"""
Django settings for janken_app project.
...
SESSION_COOKIE_DOMAIN = 'http:' + MY_IP + ':8001'
...
WSGI_APPLICATION = 'janken_app.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'janken_db',  # Name of the database service in docker-compose
        'PORT': '5432',
    }
}
