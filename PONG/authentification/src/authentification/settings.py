...
SECRET_KEY = 'django-insecure-7(*r286@2mcp7q$k)vcqc$sy@*2texbg4v9k1k(pr8$sh18f1g'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '[::1]', '192.168.64.15']
...
DATABASES = {
    'default': {
        ...
        'HOST': 'authentification_db',  # Name of the database service in docker-compose
        'PORT': '5432',
    }
}
