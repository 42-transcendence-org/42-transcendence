...
function xa() {
	if (!L) {
		...
		I.a < w ? (I.a = w) : I.a > t && (I.a = t); // prevent paddles from exiting screen
		J.a < w ? (J.a = w) : J.a > t && (J.a = t); // prevent paddles from exiting screen
		q.fillStyle = "lightgray"; // draw bg
		q.fillRect(I.c, I.a, I.width, I.height); // draw paddles
		q.fillRect(J.c, J.a, J.width, J.height); // draw paddles
		e.a += e.i; // move ball
		e.b += e.c; // move ball
		// check if ball hit bottom or top wall
