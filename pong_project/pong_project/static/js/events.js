...
document.addEventListener('DOMContentLoaded', function () {
	...
	document.getElementById('local-button').addEventListener('click', () => create_session(0, g.TYPE_LOCAL, "Player 1", "Player 2"));
	document.getElementById('remote-button').addEventListener('click', () => requests.send_game_creation_request());
	document.getElementById('ai-button').addEventListener('click', () => create_session(0, g.TYPE_AI, "Player 1", "Computer"));
