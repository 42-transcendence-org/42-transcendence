    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('local', 'Local'), ('remote', 'Remote'), ('ai', 'AI')], max_length=32)),
                ('status', models.CharField(choices=[('waiting', 'Waiting for player...'), ('active', 'Active'), ('paused', 'Paused'), ('ended', 'Ended')], max_length=32)),
                ...
                ('player1', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='game_sessions_as_player1', to=settings.AUTH_USER_MODEL)),
                ('player2', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='game_sessions_as_player2', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
